...
public class AktivnostiStudenta {
    ...
    public AktivnostiStudenta(int idAktivnosti, String pocetak, String kraj, String danIzvodenja, String dvorana, int idTipAktivnosti, String nazivTipaAktivnosti, String nazivKolegija) {
