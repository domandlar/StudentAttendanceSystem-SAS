...
public class LabsList extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, SasWsDataLoadedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.nav_seminars:
                Intent intent = new Intent(LabsList.this, SeminarList.class);
                startActivity(intent);
                break;
            case R.id.nav_labs:
                intent = new Intent(LabsList.this, LabsList.class);
                startActivity(intent);
                break;
    ...
    public void onWsDataLoaded(Object message, String status, Object data) {
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                Aktivnost novaAktivnost = new Aktivnost("Labos");
