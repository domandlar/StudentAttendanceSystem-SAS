...
import com.foi.air.studentattendancesystem.uistudent.ScheduleForDayStudent;

import java.util.ArrayList;
import java.util.List;

public class ScheduleAdapterStudent extends RecyclerView.Adapter<ScheduleAdapterStudent.ScheduleViewHolder>{

    private String[] days;
    private Context mCtx;

    public ScheduleAdapterStudent(Context mCtx, String[] days) {
        this.mCtx = mCtx;
        this.days = days;
    }
        ...
        public ScheduleViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override public void onClick(View v) {
                    ...
                    switch(position){
                        case 0:
                            Intent intent = new Intent(mCtx, ScheduleForDayStudent.class);
                            intent.putExtra("day", "Ponedjeljak");
                            mCtx.startActivity(intent);
                            break;
                        case 1:
                            intent = new Intent(mCtx, ScheduleForDayStudent.class);
    ...
    public ScheduleViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.adapter_schedule_student, viewGroup, false);
