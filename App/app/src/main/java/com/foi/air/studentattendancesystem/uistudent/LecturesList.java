...
import com.foi.air.studentattendancesystem.uiprofesor.AddLecture;
...
public class LecturesList extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, SasWsDataLoadedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()){
            ...
            case R.id.nav_generate_passwords:
                intent = new Intent(LecturesList.this, PasswordFragment.class);
