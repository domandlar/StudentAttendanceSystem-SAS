...
public class ChangeLecture extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, SasWsDataLoadedListener {

    private Toolbar toolBar;
    private DrawerLayout drawer;
    private Button btnChangeLecture;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_lecture);
        ...
        pocetakSata=getIntent().getStringExtra("pocetak");
        krajStata =getIntent().getStringExtra("kraj");
        dozvoljenoIzostanaka=Integer.parseInt(getIntent().getStringExtra("dozvoljenoIzostanaka"));
        ...
        mEditPocetakSata.setText(getIntent().getStringExtra("pocetak"));
        mEditKrajSata.setText(getIntent().getStringExtra("kraj"));
        mEditDozvoljenoIzostanaka.setText(getIntent().getStringExtra("dozvoljenoIzostanaka"));


        btnChangeLecture = findViewById(R.id.buttonAzurirajPredavanje);
        btnChangeLecture.setOnClickListener(new View.OnClickListener() {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()){
            case R.id.nav_seminars:
                Intent intent = new Intent(ChangeLecture.this, ListOfSeminars.class);
                startActivity(intent);
                break;
            case R.id.nav_labs:
                intent = new Intent(ChangeLecture.this, ListOfLabs.class);
                startActivity(intent);
                break;
            case R.id.nav_courses:
                intent = new Intent(ChangeLecture.this, ListOfCourses.class);
                startActivity(intent);
                break;
            case R.id.nav_schedule:
                intent = new Intent(ChangeLecture.this, ScheduleProfesor.class);
                startActivity(intent);
            case R.id.nav_lectures:
                intent = new Intent(ChangeLecture.this, ListOfLectures.class);
                startActivity(intent);
                break;
